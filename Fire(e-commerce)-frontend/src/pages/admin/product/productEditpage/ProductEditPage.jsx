...
import { useAddProductMutation,useUpdateProductMutation,useLazyGetProductByIdQuery } from "../../../../slices/admin/products/productApiSlice";
...
const EditProductForm = () => {
  ...
  const [getProductById, { data: productData, isLoading: productLoading, isError: ProductError }] = useLazyGetProductByIdQuery();
  const [
    triggerGetBrands,
...
//// initial form values
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      ...
      if (upLoadedThumbnail && upLoadedThumbnail!==currentProduct?.thumbnail) {
                    ...
                    <div>
                      {form.values.stockAndSize.map((item, index) => (
                        ...
                        >
                         ...
                         <div >
                          <div className="flex items-center"><span >size:</span>
                            <Field
